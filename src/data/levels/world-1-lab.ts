...
export const labLevels: Level[] = [
  ...
  },
  {
    ...
    strokesMax: 1,
    obstacles: [
      { points: [{ x: 0.25, y: 0.12 }, { x: 0.25, y: 0.88 }] },
      { points: [{ x: 0.65, y: 0.12 }, { x: 0.65, y: 0.88 }] },
    ],
  },
  {
    id: 'lab-15',
    ...
    strokesMax: 2,
    obstacles: [
      { points: [{ x: 0.15, y: 0.55 }, { x: 0.55, y: 0.55 }], motion: { ax: 0.0, ay: 0.12, period: 2.0 } },
      { points: [{ x: 0.5, y: 0.25 }, { x: 0.92, y: 0.4 }] },
    ],
  },
]
